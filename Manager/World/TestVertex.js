...
export default class TestVertex {
  constructor(manager, group) {
    ...
    this.group = group;
    this.planeGeo = new PlaneGeometry(2,4,20,40)
    this.plane = new Mesh( this.planeGeo, this.buildTwistMaterial( 1 ) );
  ...
  buildTwistMaterial( amount ) {
    ...
    material.onBeforeCompile = function ( shader ) {
      ...
      shader.vertexShader = 'precision mediump float; uniform float uTime; varying vec2 vUv;\n' + shaderNoise.join( '\n' ) + shader.vertexShader;
